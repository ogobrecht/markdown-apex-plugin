...
//--------------------------------------------------------------------------------------------------
// Source: libraries/stackoverflow-pagedown/Markdown.Converter.js
...
//--------------------------------------------------------------------------------------------------
// Source: libraries/stackoverflow-pagedown/Markdown.Sanitizer.js
...
//--------------------------------------------------------------------------------------------------
// Source: sources/markdown.editor-for-apex.js

// Modified version of "lib/stackoverflow-pagedown/Markdown.Editor.js" for Oracle APEX:
// Problem: The ID's of the textareas needs to have the APEX ID's, for markdown this needs to be "wmd-input" + postfix.
// Solution: New paramater to use the APEX ID's (search for "idAPEX", four occurences)

// needs Markdown.Converter.js
...
(function () {
	...
	Markdown.Editor = function (markdownConverter, idPostfix, idAPEX, options) {
	...
	function PanelCollection(postfix, idAPEX) {
		this.buttonBar = doc.getElementById("wmd-button-bar" + postfix);
		this.preview = doc.getElementById("wmd-preview" + postfix);
		this.input = doc.getElementById(idAPEX); // original: doc.getElementById("wmd-input" + postfix);
	}
	...
	// http://stackoverflow.com/questions/17974859/difference-between-offsetparent-and-parentelement-or-parentnode
...
//--------------------------------------------------------------------------------------------------
// Source: libraries/pagedown-extra-plugins/Markdown.Extra.js
...
//--------------------------------------------------------------------------------------------------
// Source: sources/markdown.apex-plugin-logic.js
